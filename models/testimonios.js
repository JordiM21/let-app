...
const testimonios = [
  ...
  {
    person: Girl,
    message: "Hice crecer mi emprendimiento aprendiendo inglés con LET",
    flag: colombia
  },
  {
    person: Patricia,
    message: "Mi nieto es el mejor de la clase en inglés gracias a el método LET",
    flag: bolivia
  },
  {
    person: Yessica,
    message: "Vencí mi miedo a hablar en inglés con las clases en vivo de LET",
    flag: venezuela
  },
]
