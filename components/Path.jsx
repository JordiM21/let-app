...
import LETcalendar from '@/public/LETcalendar.png'
import chatLet from '@/public/chat-let.png'
import certificate from '@/public/certificate-detailed.png'
...
export default function Path() {
  return (
    <div className='mx-8 md:mx-auto max-w-xl '>
      ...
      <div className='flex flex-col'>
        <div className='my-12 relative'>
          ...
          <Image src={PlatformTour} className='w-70 mx-auto' />
        ...
        <div className='my-12 relative'>
          ...
          <Image src={LETcalendar} className='w-70 my-4 mx-auto' />
        ...
        <div className='my-12 relative'>
          ...
          <Image src={chatLet} className='w-70 my-4 mx-auto' />
